...
export default function App() {
    ...
    //var che serve per fare il render solo una volta quando ho i dati del gps altrimenti entra in loop perchè continua a salvare i dati del gps in location
    ...
    return (
        <View style={styles.main}>
            ...
            <View style={styles.down}>
                {showDetails ? <View style={styles.down_company}>
